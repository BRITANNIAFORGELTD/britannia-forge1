...
export default function CustomerLogin() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead 
        title="Customer Login | Britannia Forge"
        description="Login to your Britannia Forge customer account to view job history, track active work, and request new services."
      />
      <Header />
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Access your Britannia Forge customer account
            </CardDescription>
          </CardHeader>
          <CardContent>
